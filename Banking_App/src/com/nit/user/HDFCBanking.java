...
import com.nit.implimentation.HDFCBankApp;

public class HDFCBanking
{
	HDFCBankApp user2= new HDFCBankApp();
	Scanner sc=new Scanner(System.in);
	
	public void HDFCLogin(BankUser bank)
	{
		...
		try 
		{
			if(user2.login(password,userName))
			{
				HDFC();
			}
		}
	...
	public void HDFC()
	{
		System.out.println("Welcome to HDFC....");
				...
				while(userValue==5)
				{
					...
					System.out.println("Press 4 for the loan");
	...
	public void withdraw()
	{
		...
		int wamount=sc.nextInt();
		 try
		 {
			...
			int pin=sc.nextInt();
				if(user2.securityPin(pin))
				{
					try 
					{
						user2.withdraw(wamount);
						System.out.println("Transaction Success");
					}
					catch (InvalidAmountException e)
					 {
	...
	{   
		...
		System.out.println("You will get 60% of your bike prize as Loan with 1.5% Interest");
	...
	public void carLoan()
	{
		...
		System.out.println("you had bought that after the year 2015");
		System.out.println("You will get 60% of your car prize as Loan with 1.5% Interest");
		System.out.println("Do you want to continue(yes/no)");
		sc.nextLine();
		String choice=sc.nextLine();
		if(choice.equalsIgnoreCase("yes"))
